...
-- Adicione com um único INSERT, duas linhas à tabela order_details com os mesmos
-- dados do requisito 20.

-- Observações técnicas: Esses dados são novamente order_id: 69, product_id: 80,
